package com.example.cinenowapp.detail.presentation.ui
...
private fun MovieDetailPreview() {
    CineNowAppTheme {
        val movie = MovieDto(
            ...
            title = "Title",
            posterPath = "sosonsos",
            overview = "Long overview movie Long overview movie Long overview movie" +
                    "Long overview movie Long overview movie Long overview movie " +
